...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate an image with Agnes Image API.")
    parser.add_argument("--prompt", required=True, help="English image prompt.")
...
def main() -> None:
    ...
    try:
        ...
        if args.dry_run:
            from agnes_common import validate_size, _parse_model_list, normalize_model_name
            ...
            payload = generate_image(prompt, model, args.size)
